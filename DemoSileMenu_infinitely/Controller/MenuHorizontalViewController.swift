...
class MenuHorizontalViewController: UIViewController,FSPagerViewDataSource,FSPagerViewDelegate {
    
    fileprivate let imageNames = ["11","12","13","14","15","16","17"]
    ...
    fileprivate var typeIndex = 0 {
        didSet {
            ...
            case .linear, .overlap:
                let transform = CGAffineTransform(scaleX: 0.2, y: 0.8)
